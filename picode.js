...
const logFile = path.join(logsDir, `run-pcode-log-${timestamp}.txt`);
...
try {
  ...
  const command = `node ./node_modules/@playwright/test/cli.js test tests/validate-pincodes.spec.ts --headed`;
